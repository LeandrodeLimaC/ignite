...
type TextInputProps = ComponentProps$1<typeof Input> & {
    prefix?: string;
};
declare const TextInput: ({ prefix, children, ...props }: TextInputProps) => JSX.Element;
...
declare const MultiStep: ({ size, currentStep }: MultiStepProps) => JSX.Element;
